    ...
    $(document).on("click", ".filter-by-category", function () {
        ...
        if ($(this).children().first().hasClass("checked")) {
            ...
            $.each(parent.children(), function (index, product) {
                ...
                if ($(product).attr("category-id") == productId) {
                    product.remove();
    ...
    $(document).on("click", ".filter-by-rating", function () {
        ...
        if ($(this).children().first().hasClass("checked")) {
            ...
            $.each(parent.children(), function (index, product) {
                ...
                if ($(product).attr("rating-id") == productId) {
                    product.remove();
                    if (parent.children().length == 0) {
                        $.ajax({
                            url: "Shop/GetPaginatedDatas",
...
$(document).ready(function () {
    ...
    $(document).on("click", ".filter-by-tag", function () {
        ...
        let inputs = $(".tag-filter")

        if ($(this).children().first().hasClass("checked")) {
            $.ajax({
                url: "Shop/FilterByTag",
                type: "Get",
                data: data,
                success: function (res) {
            ...
            $.each(parent.children(), function (index, product) {
                if ($(product).attr("tag-id") == productId) {
                    product.remove();
                    if (parent.children().length == 0) {
                        $.ajax({
                            url: "Shop/GetPaginatedDatas",
...
$(document).ready(function () {
    ...
    $(document).on("click", ".filter-by-brand", function () {
        ...
        let inputs = $(".brand-filter")

        if ($(this).children().first().hasClass("checked")) {
            $.ajax({
                url: "Shop/FilterByBrand",
                type: "Get",
                data: data,
                success: function (res) {
            ...
            $.each(parent.children(), function (index, product) {
                if ($(product).attr("brand-id") == productId) {
                    product.remove();
                    if (parent.children().length == 0) {
                        $.ajax({
                            url: "Shop/GetPaginatedDatas",
