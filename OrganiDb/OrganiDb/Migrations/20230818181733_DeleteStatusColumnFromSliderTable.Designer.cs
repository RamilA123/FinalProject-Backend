...
namespace OrganiDb.Migrations
{
    ...
    [Migration("20230818181733_DeleteStatusColumnFromSliderTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrganiDb.Models.About_", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OrganiDb.Models.Author", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OrganiDb.Models.Banner", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2023, 8, 18, 22, 17, 32, 886, DateTimeKind.Local).AddTicks(9145),
                        ...
                        {
                            Id = 2,
                            CreatedDate = new DateTime(2023, 8, 18, 22, 17, 32, 886, DateTimeKind.Local).AddTicks(9157),
                            Image = "banner1.png",
                            SoftDelete = false
                        },
                        new
                        {
                            Id = 3,
                            CreatedDate = new DateTime(2023, 8, 18, 22, 17, 32, 886, DateTimeKind.Local).AddTicks(9158),
                            Image = "banner2.png",
                            SoftDelete = false
                        },
                        new
                        {
                            Id = 4,
                            CreatedDate = new DateTime(2023, 8, 18, 22, 17, 32, 886, DateTimeKind.Local).AddTicks(9159),
                            Image = "banner4.png",
                            SoftDelete = false
                        },
                        new
                        ...
                        {
                            Id = 6,
                            CreatedDate = new DateTime(2023, 8, 18, 22, 17, 32, 886, DateTimeKind.Local).AddTicks(9160),
                            Image = "banner3.jpg",
                            SoftDelete = false
                        },
                        new
                        {
                            Id = 7,
                            CreatedDate = new DateTime(2023, 8, 18, 22, 17, 32, 886, DateTimeKind.Local).AddTicks(9162),
                            Image = "banner6.jpg",
                            SoftDelete = false
                        },
                        new
                        {
                            Id = 8,
                            CreatedDate = new DateTime(2023, 8, 18, 22, 17, 32, 886, DateTimeKind.Local).AddTicks(9163),
                            Image = "banner7.webp",
                            SoftDelete = false
                        },
                        new
                        ...
                        {
                            Id = 10,
                            CreatedDate = new DateTime(2023, 8, 18, 22, 17, 32, 886, DateTimeKind.Local).AddTicks(9164),
                            Image = "banner9.jpg",
                            SoftDelete = false
                        },
                        new
                        ...
                        {
                            Id = 12,
                            CreatedDate = new DateTime(2023, 8, 18, 22, 17, 32, 886, DateTimeKind.Local).AddTicks(9165),
                            Image = "banner10.webp",
                            SoftDelete = false
                        });
                });
            ...
            modelBuilder.Entity("OrganiDb.Models.Blog_", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OrganiDb.Models.BlogReview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OrganiDb.Models.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OrganiDb.Models.Assistance", b =>
                {
                    b.HasOne("OrganiDb.Models.About_", "About")
            ...
            modelBuilder.Entity("OrganiDb.Models.Blog_", b =>
                {
                    b.HasOne("OrganiDb.Models.Author", "Author")
                        .WithMany("Blogs")
            ...
            modelBuilder.Entity("OrganiDb.Models.BlogReview", b =>
                {
                    b.HasOne("OrganiDb.Models.Blog_", "Blog")
